...
// Equipment placeholder image utility function
const getEquipmentPlaceholder = (theme: 'light' | 'dark' = 'light') => {
...
const Equipment: React.FC = () => {
	...
	// Equipment data with theme-aware placeholder images
	const equipmentData = useMemo(() => [
		// Pioneer DJ Controllers & All-in-One Systems
		{
			...
			imageUrl: getEquipmentPlaceholder(theme),
			available: true,
