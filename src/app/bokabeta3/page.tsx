...
const StickyShowcase = () => {
  ...
  // Fixed options for calculation (no user selection needed)
  ...
  return (
    <div className="showcase-container flex flex-col md:flex-row min-h-screen bg-white dark:bg-black transition-colors duration-200">
      {/* Left Card */}
      <div className="md:w-1/3 w-full p-4">
        <div className="md:sticky top-4">
          <div className="card bg-white dark:bg-gray-900 shadow-lg rounded-lg p-4 h-[400px] max-w-md mx-auto border border-gray-200 dark:border-gray-800">
            <DjSetup
              speaker={speaker}
              djTable={djTable}
      ...
      <div className="scrolling-content md:w-2/3 w-full p-4">
        ...
        <div className="flex-1 mt-6 md:mt-0">
          ...
          {/* Speaker Section */}
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200">Högtalare</h3>
                  ...
                  <button
                    ...
                    className={`block w-full text-left px-4 py-3 border rounded-lg transition-colors ${
                      speaker.name === option.name
                        ...
                        : "border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 hover:border-gray-400 dark:hover:border-gray-600"
                    }`}
                  >
          ...
          {/* DJ Table Section */}
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200">DJ Bord</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {/* Player Section */}
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200">Spelare</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {/* Microphone Section */}
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200">Mikrofon</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Behöver du mikrofon?</p>
            <div className="space-y-2 mt-3">
          ...
          {/* Uplighting Section */}
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200">Uplighting</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Vill du ha uplighting?</p>
            <div className="space-y-2 mt-3">
          ...
          <div className="mt-6 text-center">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Totalpris: {totalCost} kr</h3>
            <button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-6 py-3 rounded-lg shadow-md transition-colors mt-4">
      ...
      {/* Floating Footer */}
      <footer className="fixed bottom-0 left-0 w-full bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800 z-50 transition-colors duration-200">
        <div className="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center">
          <span className="text-xl font-semibold text-gray-900 dark:text-gray-100">
            Totalpris: {totalCost} kr
          </span>
          <button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-6 py-3 rounded-lg shadow-md transition-colors">
            Finalisera din konfiguration
          </button>
        </div>
      </footer>
